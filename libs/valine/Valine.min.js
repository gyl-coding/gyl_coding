...
!function (e, t) {
    ...
    return function (e) {
        ...
        var x = n(3).FilterCSS, k = n(3).getDefaultWhiteList, _ = n(5), A = new x, S = /</g, O = />/g, $ = /"/g,
            E = /&quot;/g, j = /&#([a-zA-Z0-9]*);?/gim, T = /&colon;?/gim, I = /&newline;?/gim,
        ...
        o.prototype.Q = function (e) {
            ...
            var I = function (t, n, r) {
                ...
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                    ...
                    u = T.hide ? "" : true && t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (T.cdn + (0, s.default)(t.get("mail")) + T.params) + '">',
